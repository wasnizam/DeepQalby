        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-16">
          {reasons.map((reason, index) => (
            <div key={index} className="flex flex-col sm:flex-row gap-6">
              <div className="shrink-0 w-12 h-12 bg-slate-50 rounded-full flex items-center justify-center border border-slate-100">
                {reason.icon}
              </div>
              <div>
                <h4 className="text-xl font-semibold text-slate-900 mb-3">{reason.title}</h4>
